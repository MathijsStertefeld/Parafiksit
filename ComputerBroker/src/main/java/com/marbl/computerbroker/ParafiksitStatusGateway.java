...
abstract class ParafiksitStatusGateway {
    ...
    private AsynchronousRequestor<ParafiksitStatusRequest, ParafiksitStatusReply> gateway;
    ...
    public ParafiksitStatusGateway(String factoryName, String parafiksitRequestQueue, String parafiksitReplyQueue)
    {
        ...
        try {
            gateway = new AsynchronousRequestor<ParafiksitStatusRequest, ParafiksitStatusReply>(factoryName, parafiksitRequestQueue, parafiksitReplyQueue, serializer);
        } catch (Exception ex) {

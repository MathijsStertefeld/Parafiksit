...
public interface IMagazijn {
     ...
     * adres!!) Controleert of de ingevoerde waardes correct zijn. Als dit zo is
     * worden de veranderen aangebracht in de database. Zowel de naam als het
     * adres moet ingevoerd worden, als deze niet veranderd hoeven worden moeten
     * de oude waardes ingevoerd worden.
     *
     ...
     * omschrijving het aantal en de prijs!) Controleert of ingevoerde waardes
     * correct zijn. Als dit zo is worden de veranderingen aangebracht in de
     * database. De omschrijving, het aantal en de prijs moeten ingevoerd
     * worden, als er niets veranderd hoeft te worden, voer dan de oude waardes
     * in.
     *

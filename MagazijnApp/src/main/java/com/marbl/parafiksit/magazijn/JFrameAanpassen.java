...
import com.marbl.parafiksit.magazijn.domain.Klant;
import com.marbl.parafiksit.magazijn.domain.Onderdeel;
...
public class JFrameAanpassen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.marbl.parafiksit.magazijn.MagazijnApplicatieApp.class).getContext().getResourceMap(JFrameAanpassen.class);
    ...
    private void jBtAanpassenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAanpassenActionPerformed
        if (soort.equals("Klant")) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "De waardes zijn niet correct ingevuld!", "Fout", JOptionPane.ERROR_MESSAGE);
            }
        } else if (soort.equals("Onderdeel")) {
            try {
